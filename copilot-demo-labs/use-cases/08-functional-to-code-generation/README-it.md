# Laboratorio 08 - Da Requisiti a Codice
...
> **Nota:** I 4 prompt formano una catena completa (Prompt Chaining): user story → scheletro → verifica → implementazione → test. Ogni prompt usa l'output del precedente come contesto.
...
**Tecniche utilizzate:** Prompt Chaining · Reflexion
- "Analizza questa user story e verifica se il design API nel mio codice copra tutti i requisiti."

**Tecniche utilizzate:** Prompt Chaining · Chain-of-Thought (istruzione aggiuntiva)
...
**Tecniche utilizzate:** Prompt Chaining · Reflexion (istruzione aggiuntiva)
