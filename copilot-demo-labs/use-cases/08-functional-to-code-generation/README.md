# Lab 08 - From Requirements to Code
...
> **Note:** The 4 prompts form a complete chain (Prompt Chaining): user story → skeleton → verification → implementation → tests. Each prompt uses the output of the previous one as context.
...
**Techniques used:** Prompt Chaining · Reflexion
- "Analyze this user story and check if the API design in my code covers all requirements."

**Techniques used:** Prompt Chaining · Chain-of-Thought (additional instruction)
...
**Techniques used:** Prompt Chaining · Reflexion (additional instruction)
