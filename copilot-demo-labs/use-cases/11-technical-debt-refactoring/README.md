# Lab 11 - Technical Debt Analysis and Refactoring
...
**Additional technique:** Tree of Thoughts (Lab 10) — explores alternatives before converging on a solution.
...
**Additional technique:** Reflexion (Lab 10) — the AI critiques its own output and improves it autonomously.
